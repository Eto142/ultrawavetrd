...
>
    ...
    >
        ...
        <div class="flex items-center justify-between h-16 px-4 border-b border-surface-border shrink-0">
            <a href="{{ url('/') }}" class="flex items-center">
                <img src="{{ url('/') }}/storage/app/public/photos/RByLroJ7nnT2IoSLNkiKQu84lT0tyjLhtaA68IVj.png" alt="Ultrawavetrd" class="h-8 w-auto max-w-[140px] object-contain">
            </a>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
        ...
        <div class="px-4 py-4 border-b border-surface-border shrink-0">
            <div class="flex items-center gap-3">
                         ...
                         class="w-10 h-10 rounded-full object-cover bg-surface-overlay shrink-0">
                                <div class="min-w-0">
                    <p class="text-sm font-medium text-content-primary truncate">egod</p>
        ...
        <nav class="flex-1 overflow-y-auto py-2">
            ...
            <a href="{{ url('/') }}" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
 ...
 Transactions
                        ...
                        <a href="{{ url('/') }}/loans/apply" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
 ...
 Investment Plans
                                    ...
                                    <a href="{{ url('/') }}/pre-ipo" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
 ...
 Referral Program
            ...
            <a href="{{ route('user.news') }}" class="nav-link-item nav-link-active">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
...
-->
        ...
        <div class="border-t border-surface-border p-4 shrink-0">
            <form method="POST" action="{{ url('/') }}/logout" id="sidebar-logout-form">
                <input type="hidden" name="_token" value="33urHJ6yXCmJ10M5P6VQb1q8wXyBAhRpUNl6CGKT">            </form>
            <a href="{{ url('/') }}/logout"
 ...
 Logout
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                ...
                <h1 class="text-lg font-semibold text-content-primary hidden sm:block">News</h1>
            </div>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" />
                        ...
                        <a href="{{ url('/') }}/notification" class="block text-center text-xs text-primary hover:text-primary-light py-3 border-t border-surface-border transition-colors">View all notifications</a>
                    </div>
                </div>
                ...
                <div class="relative" @click.away="userDropdown = false">
                    <button @click="userDropdown = !userDropdown" class="flex items-center gap-2 p-1.5 rounded-lg hover:bg-surface-overlay transition-colors">
                                 ...
                                 class="w-8 h-8 rounded-full object-cover bg-surface-overlay">
                                                <span class="text-sm font-medium text-content-primary hidden md:block">egod</span>
 ...
 Support-->
    ...
    <div class="mb-6">
    <h2 class="text-xl font-bold text-content-primary">Market News</h2>
            <p class="text-sm text-content-secondary mt-1">Latest financial, forex, and stock market news</p>
    </div>
