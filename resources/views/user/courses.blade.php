@include('user.header')
 ...
 Support-->
    ...
    <div class="mb-6">
    <h2 class="text-xl font-bold text-content-primary">Courses</h2>
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-content-secondary mt-1">Learning often happens in classrooms but it doesn't have to. Use Ultrawavetrd to facilitate learning experiences no matter the context.</p>
            </div>
